...
const practise_automation_form_fields_test_data_1 = require("../../../testdata/testdata/practise-automation-form-fields-test-data");
...
function navigateToFormFieldsPage() {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        yield (0, _PageUtils_1.gotoURL)(formFieldsPageURL);
    });
}
...
function fillForm() {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        yield nameInput().fill(practise_automation_form_fields_test_data_1.FormFieldsCredentials.name);
        yield passwordInput().fill(practise_automation_form_fields_test_data_1.FormFieldsCredentials.password);
        ...
        yield emailInput().fill(practise_automation_form_fields_test_data_1.FormFieldsCredentials.email);
        yield messageInput().fill(practise_automation_form_fields_test_data_1.FormFieldsCredentials.message);
