...
const keyPressInput = () => (0, _LocatorUtils_1.getLocatorByRole)('textbox');
const resultText = () => (0, _LocatorUtils_1.getLocatorByRole)('status');
const targetElement = () => (0, _LocatorUtils_1.getLocatorByRole)('textbox');
